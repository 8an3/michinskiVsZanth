  ...
  return (
    <Tabs defaultValue="to-do" className="w-[95%]  mx-auto my-auto">
      <TabsList className="rounded-[6px] ">
        ...
        <TabsTrigger className="rounded-[6px] " value="part2">part 2</TabsTrigger>
        <TabsTrigger className="rounded-[6px] " value="ques for duty counc">Notes</TabsTrigger>
      </TabsList>
      <TabsContent value="to-do">
        <iframe className='mx-auto' src='/michinskiVsZanth/Form10Answer-Respondent-JustinSkylerZanth03-JUN-2024.pdf' width="95%" height="1000px" />

      </TabsContent>
      <TabsContent value="part2">
        <iframe className='mx-auto' src='/michinskiVsZanth/form10answerpart2.pdf' width="95%" height="1000px" />
